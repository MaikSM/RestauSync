...
exports.IsWaiterOrAdminMiddleware = void 0;
// Importa la utilidad JwtUtil para verificar la validez de los tokens JWT.
const jwt_util_1 = require("../../utils/jwt.util");
// Define la clase IsWaiterOrAdminMiddleware que contendrá el middleware para verificar si el usuario tiene el rol de mesero o administrador.
class IsWaiterOrAdminMiddleware {
    // Método estático que actúa como middleware para comprobar si el usuario tiene el rol de mesero o administrador.
    ...
    next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Verifica si el usuario tiene el rol de administrador (role_id === 1) o mesero (role_id === 2).
                // Si no lo tiene, responde con un error 401 (No autorizado).
                if (((_c = decoded === null || decoded === void 0 ? void 0 : decoded.data) === null || _c === void 0 ? void 0 : _c.role_id) !== 1 && ((_d = decoded === null || decoded === void 0 ? void 0 : decoded.data) === null || _d === void 0 ? void 0 : _d.role_id) !== 2)
                    return res.status(401).json({ message: 'Unauthorized' });
                // Si el token es válido y el usuario es mesero o administrador, continúa con el siguiente middleware o controlador.
                next();
            }
            catch (error) {
...
exports.IsWaiterOrAdminMiddleware = IsWaiterOrAdminMiddleware;
