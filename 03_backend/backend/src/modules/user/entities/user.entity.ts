...
export class UserEntity extends BaseEntity {
  ...
  // Columna para almacenar la hora de entrada del empleado.
  @Column({
    type: 'time',
    nullable: true, // Permite valores nulos inicialmente.
  })
  hora_entrada: string;

  // Columna para almacenar la hora de salida del empleado.
  @Column({
    type: 'time',
    nullable: true, // Permite valores nulos inicialmente.
  })
