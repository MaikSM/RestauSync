...
export class DatabaseConfig {
  ...
  public static readonly port: number =
    Number(process.env.DB_PORT || '3306') || 3306; // Convierte el puerto a número o usa 3306 por defecto.
  ...
  public static readonly database: string = process.env.DB_NAME || 'prueba'; // Obtiene el nombre de la base de datos o usa "prueba" por defecto.
}
